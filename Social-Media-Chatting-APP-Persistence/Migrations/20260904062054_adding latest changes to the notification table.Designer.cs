...
namespace Social_Media_Chatting_APP_Persistence.Migrations
{
    ...
    [Migration("20260904062054_adding latest changes to the notification table")]
    partial class addinglatestchangestothenotificationtable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Social_Media_Chatting_APP_Domain.Entities.DeviceToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Social_Media_Chatting_APP_Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Social_Media_Chatting_APP_Domain.Entities.PushSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Social_Media_Chatting_APP_Domain.Entities.Notification", b =>
                {
                    b.HasOne("Social_Media_Chatting_APP_Domain.Entities.AppUser", "Actor")
                        .WithMany()
                        .HasForeignKey("ActorId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Social_Media_Chatting_APP_Domain.Entities.AppUser", "Recipient")
                        .WithMany()
